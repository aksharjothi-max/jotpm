    ...
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-gray-200">
      <div className="max-w-[980px] mx-auto px-6 h-12 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6">
          ...
          <Link href="/blog" className="text-xs text-gray-600 hover:text-gray-900 transition-colors">
            Blog
          </Link>
          <Link href="/about" className="text-xs text-gray-600 hover:text-gray-900 transition-colors">
            About
          </Link>
          <Link href="/#contact" className="text-xs font-medium px-3 py-1 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition-all">
            Contact
          </Link>
        </nav>
      </div>
