export default function AboutPage() {
  return (
    <section className="min-h-screen bg-white dark:bg-black py-24">
      <div className="max-w-[680px] mx-auto px-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8 md:p-12">
          ...
          <div className="space-y-4 text-gray-600 dark:text-gray-300 leading-relaxed">
            <p>
              <strong className="text-gray-900 dark:text-gray-100">Note to self:</strong> This section will contain a personal summary about who you are, your background, and what drives you as a product manager.
            </p>
            <p>
